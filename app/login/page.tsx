...
import {
  ...
  Check, TrendingUp, Calendar, BarChart3,
} from "lucide-react"
      ...
      <div className="relative">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-6 border border-amber-300 bg-white/60">
            ...
            <span className="text-[11px] text-amber-800 font-semibold tracking-wide">AI-POWERED CONTENT ENGINE</span>
          </div>
          ...
          >
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#F7BE4D] to-[#f0a800] flex items-center justify-center text-xs font-bold text-[#050816]">
                <Sparkles className="w-3.5 h-3.5" />
              </div>
              <div>
                <p className="text-xs font-semibold text-slate-800">Example output</p>
                <p className="text-[10px] text-slate-400">Generated by PostPilot AI</p>
              </div>
      ...
      <div className="relative">
        ...
        <div className="rounded-xl p-4 bg-white border border-amber-200 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-semibold text-slate-800">No credit card required to start</span>
          </div>
          <p className="text-xs text-slate-600 leading-relaxed">
            Paste one idea and get platform-ready posts for every major social network — free to try, upgrade only if you need more.
          </p>
        </div>
      </div>
    </div>
